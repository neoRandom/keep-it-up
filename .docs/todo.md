- TODO: add a username index on the players table, because username lookups are used for authentication and player lookup queries such as GetPlayerByUsername and password validation checks.
