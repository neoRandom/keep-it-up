...
- [x] TODO: redesign the password change flow in the PlayerManagement interface and struct:
...
- [x] TODO: add ValidatePlayerPassword method to the Authentication interface so login and password-change flows can reuse the same password validation rule for checking the current password before sensitive mutations.
